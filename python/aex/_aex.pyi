...
# Text, or (descr, shape, bytes) for numbers.
AttrValue = str | tuple[str, list[int], bytes]
...
class Client:
    ...
    def get_item(self, handle: int, name: str) -> tuple[Item, dict[str, AttrValue]]: ...
    def list_children(
        self, handle: int, name: str
    ) -> list[tuple[str, Item, dict[str, AttrValue]]]: ...
    def prepare(
        self,
        handle: int,
        name: str,
