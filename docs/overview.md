...
| [zarr-python とのリモート比較](benchmark-zarr-remote.md) | VM 間 + netem | 同じストアを HTTP でも配って比べた。16 プロセスの zarr-python に 1.53 〜 2.01 倍。よく圧縮できるデータは 25 ms より遠いと逆転し、1 Gbit/s の回線なら SZ3 で 7.0 倍取り返す |
